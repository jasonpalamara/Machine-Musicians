        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 565.0, 310.0, 260.0, 91.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 9,
                    "outlettype": [ "int", "int", "float", "float", "float", "", "int", "float", "" ],
                    "patching_rect": [ 65.0, 208.0, 103.0, 22.0 ],
                    "text": "transport"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 16.0, 208.0, 39.0, 22.0 ],
                    "text": "metro"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 16.0, 381.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
