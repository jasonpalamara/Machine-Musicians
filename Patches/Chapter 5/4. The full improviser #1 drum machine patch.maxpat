        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 18.0, 805.0, 257.0, 118.0 ],
                    "presentation_linecount": 14,
                    "text": "*ERRATA!\nIn the published first edition, image 5.4 includes the \"send MIDIears\" object before it is discussed in the text. This will be fixed in future editions, but for now, this patch should work as shown anyway. Keep reading Chapter 5 for an explanation of send objects and their usage here.",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 931.0, 765.0, 221.0, 64.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 963.0, 202.0, 264.0, 91.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 5343.0, 79.0, 661.9999999999999, 890.929515418502 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 275.0, 814.0, 83.0, 60.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 253.0, 764.0, 105.0, 47.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 253.0, 732.0, 105.0, 33.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 359.0, 832.0, 87.0, 22.0 ],
                    "text": "send MIDIears"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 359.0, 744.0, 54.0, 22.0 ],
                    "text": "pack 0 0"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "int", "" ],
                    "patching_rect": [ 359.0, 770.0, 82.0, 22.0 ],
                    "text": "midiformat"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 509.0, 770.0, 151.0, 87.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 3,
                    "numoutlets": 0,
                    "patching_rect": [ 457.0, 770.0, 49.0, 22.0 ],
                    "text": "noteout"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 362.0, 717.0, 125.0, 22.0 ],
